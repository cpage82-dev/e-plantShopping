...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Chris' Nursery, your local plant superstore!</p>
      <p className="about-us-content">
        At Chris' Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
